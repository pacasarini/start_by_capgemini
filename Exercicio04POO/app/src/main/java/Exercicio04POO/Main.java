...
da fatura (isso é, multiplica a quantidade pelo preço por item) e depois retorna 
...
public class Main {
    ...
    public static void main(String[] args) {
        //"inv" eh o indice da classe Invoice que estamos dando agora para acessar a classe Invoice
        Invoice inv = new Invoice(1, "mousepad", 10, 50.0f);
        System.out.println("Valor total é: " + inv.getInvoiceAmount());
    }
